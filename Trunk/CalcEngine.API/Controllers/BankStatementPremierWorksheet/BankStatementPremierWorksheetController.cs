...
namespace CalcEngine.API.Controllers.BankStatementPremierWorksheet
{
    [Produces("application/json")]
    [Route("api/BankStatementPremierWorksheet")]
    public class BankStatementPremierWorksheetController : Controller
    {
        ...
        public BankStatementPremierWorksheetController(
        ...
        public async Task<ActionResult> CalculateWorksheet(string fileId)
        {
            try
            {
                this.Info("Calculating BankStatement Premier worksheet");
                ...
                if (calcs.Message == null)
                {
                    ...
                    worksheet.UsableCashoutProceeds = 0;

                    worksheet.NetReservesNeededAfterCashOut = worksheet.TotalRequiredReserves;
            ...
            {
                this.Error("Error in BankStatement Premier", ex.Message);
