...
namespace CalcEngine.API.Controllers.BankStatementWorksheet
{
    [Produces("application/json")]
    [Route("api/BankStatementWorksheet")]
    public class BankStatementWorksheetController : Controller
    {
        private IConfiguration _configuration = null;
        private IGetContentRequest _fileManagerApiClient = null;
        private ILoanManager _IUSLoanManager = null;

        public BankStatementWorksheetController(
