...
namespace CalcEngine.API.Controllers.DebtCovgRatioWorksheet
{
    [Produces("application/json")]
    [Route("api/DebtCovgRatioWorksheet")]
    public class DebtCovgRatioWorksheetController : Controller
    {
        ...
        public DebtCovgRatioWorksheetController(
        ...
        public async Task<ActionResult> CalculateWorksheet(string fileId)
        {
            try
            {
                this.Info("Calculating Debt Covg Ratio worksheet");
                ...
                if (calcs.Message == null)
                {
                    ...
                    worksheet.UsableCashoutProceeds = worksheet.ResidualAssets.CashFromBorrower.CashFromBorrowerTotal < 0 ?
                        Math.Abs(worksheet.ResidualAssets.CashFromBorrower.CashFromBorrowerTotal) : 0;
            ...
            {
                this.Error("Error in Debt Covg Ratio", ex.Message);
