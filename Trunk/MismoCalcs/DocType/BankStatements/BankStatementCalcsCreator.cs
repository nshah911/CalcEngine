...
namespace CalcEngine.Calcs.DocType.BankStatements
{
    public class BankStatementCalcsCreator
    {
        ...
        public BankStatementCalcsCreator(DocTypeCalcResolver resolver, IUSLoan loan)
        {
            _resolver = resolver;
            _IUSLoan = loan;
        ...
        {
            this.Info("Creating BankStatementCalcsCreator");
            ...
            if (_resolver.GuideLineDt >= GuideLineDt_20180621)
            {
                ...
                calculations = new BankStatementCalc(
                    assetCalculation,
                    creditCalculation,
