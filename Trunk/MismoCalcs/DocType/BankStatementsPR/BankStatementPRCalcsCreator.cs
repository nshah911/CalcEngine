...
using MismoCalcs.Implementation.BankStatements;
...
namespace CalcEngine.Calcs.DocType.BankStatementsPR
{
    public class BankStatementPRCalcsCreator
    {
        ...
        public BankStatementPRCalcsCreator(DocTypeCalcResolver resolver, IUSLoan loan)
        {
            _resolver = resolver;
            _IUSLoan = loan;
        ...
        public Calculations Create()
        {
            ...
            this.Info("Creating BankStatementPRCalcsCreator");
            ...
            if (_resolver.GuideLineDt >= GuideLineDt_20180621)
            {
                ...
                IReoCalcs reoCalcs = new ReoCalcs(reoModelCommonCalcs);
                ...
                IBankStatementCalcs bankStatementCalcs = new BankStatementCalcs();

                IDTICalc dTICalc = new DTIRatioBankStatement(reoCalcs, incomeCalcs, bankStatementCalcs,
                    liabilityCalcs, presentTotalHousingExpenseCalc, _IUSLoan.MismoLoan.LoanPurpose, _IUSLoan.BankStatements,
                ...
                IBaseReserveCalc baseReserveCalc = new BaseReserveCalcBKPrem(
                    ...
                    reoCalcs, proposedHousingQualifyingTIA, qualifyingPIPayment, _IUSLoan.ImpacProgramCode);
                ...
                calculations = new BankStatementPRCalc(
                    assetCalculation,
                    creditCalculation,
