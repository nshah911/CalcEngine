...
namespace CalcEngine.Calcs.DocType.Investor
{
    public class InvestorCalcsCreator
    {
        ...
        public InvestorCalcsCreator(DocTypeCalcResolver resolver, IUSLoan loan)
        {
            _resolver = resolver;
            _IUSLoan = loan;
        ...
        {
            this.Info("Creating InvestorCalcsCreator");
            ...
            if (_resolver.GuideLineDt >= GuideLineDt_20180621)
            {
                ...
                AssetCalcs assetCalcs = new AssetCalcs(assetModelCommonCalcs);

                //Transaction Details inilization for investor
                ...
                ITransactionDetailRefinanceCalcs transactionDetailRefinanceCalcs =
                    new TransactionDetailRefinanceCalcs(_IUSLoan.MismoLoan.TransactionDetail, _IUSLoan.MismoLoan.LoanPurpose._Type);
                ...
                ICashoutProceed cashoutProceedCalcs = new CashoutProceedINV(cashFromBorrowerCalcs, ltvCalc);
                ...
                IBaseReserveCalc baseReserveCalc = new BaseReverseCalc(
                    ...
                    reoCalcs,
                    dTICalc, proposedHousingQualifyingTIA, qualifyingPIPayment, _IUSLoan.ImpacProgramCode);


                INetReserveAfterCashOut netReserveAfterCashOut = new NetReserveAfterCashOutInv(_IUSLoan, ltvCalc, reoReserves, cashFromBorrowerCalcs, baseReserveCalc);
